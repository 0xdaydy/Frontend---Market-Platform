...
class TransactionRemoteDataSource {
  ...
  FutureEither<List<TransactionModel>> getTransactions() async {
    ...
    return result.flatMap((response) {
      try {
        ...
        AppLogger.error(
            'TransactionRemoteDataSource: Failed to parse getTransactions: $e',
            [e, st]);
        return left(
  ...
  FutureEither<TransactionModel> getTransaction(int id) async {
    ...
    return result.flatMap((response) {
      try {
        ...
        AppLogger.error(
            'TransactionRemoteDataSource: Failed to parse getTransaction: $e',
            [e, st]);
  ...
  FutureEither<TransactionModel> createTransaction(
    ...
    return result.flatMap((response) {
      try {
        ...
        final transaction =
            TransactionModel.fromJson(responseData['data'] ?? responseData);
        return right(transaction);
      } catch (e, st) {
        AppLogger.error(
            'TransactionRemoteDataSource: Failed to parse createTransaction: $e',
            [e, st]);
        return left(
            ServerFailure('Failed to parse created transaction: $e', error: e));
      }
    });
  }

  FutureEither<Map<String, dynamic>> validateTransaction(
      Map<String, dynamic> data) async {
    ...
    return result.flatMap((response) {
      try {
        ...
        AppLogger.error(
            'TransactionRemoteDataSource: Failed to parse validateTransaction: $e',
            [e, st]);
        return left(
            ServerFailure('Failed to parse validation response: $e', error: e));
      }
    });
  }
}
